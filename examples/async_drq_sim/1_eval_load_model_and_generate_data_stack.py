...
flags.DEFINE_string("output_path", os.path.join(os.path.dirname(__file__), "success_trajs_{}_stack_dense_reward.pkl"), "Path to save the collected data. Use {} as placeholder for num_episodes.")
flags.DEFINE_string("fail_output_path", os.path.join(os.path.dirname(__file__), "fail_trajs_{}_stack_dense_reward.pkl"), "Path to save the failed trajectories. Use {} as placeholder for num_episodes.")
...
def main(_):
    ...
    FLAGS.output_path = os.path.join(os.path.dirname(__file__), f"success_trajs_{FLAGS.target_success_count}_stack_{FLAGS.reward_type}.pkl")
    FLAGS.fail_output_path = os.path.join(os.path.dirname(__file__), f"fail_trajs_{FLAGS.target_fail_count}_stack_{FLAGS.reward_type}.pkl")
    ...
    # Environment should be registered by franka_sim.envs import above
    ...
    # Wrappers
    if FLAGS.env == "PandaStackVision-v0":

...
if __name__ == "__main__":
    ...
    parser.add_argument("--pkl_path", type=str, default="examples/async_drq_sim/fail_trajs_100_40cm_01reward.pkl", help="Path to input pickle file")
    parser.add_argument("--repo_id", type=str, default="serl/franka_lift_cube_fail_trajs_100_lerobot", help="Hugging Face repo ID or local dir name")
